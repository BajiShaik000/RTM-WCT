...
export const NewShoppingMTCForAIDesignWins = () => {
      ...
      <div className={styles.subContainer}>
        ...
        >
          ...
          >
            {messages.length > 2
              ...
              : "Product Recommendation based on your wardrobe"}
          </h1>
          {selectedProduct && (
            <div
          ...
          <div style={{ display: "flex" }}>
            ...
            >
              ...
              >
                {showWardrobe ? "Recommendations" : "Wardrobe"}
              </span>
            </div>
            <div
              className={`${styles.navItem} ${styles.cartBtn}`}
          ...
          <div className={styles.prodContainer}>
            ...
            >
              <div
                ...
                style={{
                  width: showPopup ? "calc(100vw - 650px)" : "100%",
                  padding: 0,
                }}
              >
        ...
        >
          <ArchitectureWithTags
            ...
            imageUrl="https://dreamdemoassets.blob.core.windows.net/openai/ai_first_shopping_assistant_arch_diagram.png"
            tags={[
              {
                tagName: "Select Style",
                tagDescription:
                  "Choose your vibe: Pick your desired look style.",
              },
              {
                tagName: "Text Query Generated",
                tagDescription:
                  "Tell us what you like: Describe your preferences.",
              },
              {
                tagName: "Query sent to embedding model",
                tagDescription:
                  "Safety first: We filter inappropriate content for a comfortable experience.",
              },
              {
                tagName: "User Query Optimized for Optimal Search Query",
                tagDescription:
                  "Find the perfect match: We refine your request for optimal results.",
              },
              {
                tagName: "Search for Products in the Catalog",
                tagDescription:
                  "Explore endless options: Discover products that fit your needs.",
              },
              {
                tagName: "Return Relevant Products",
                tagDescription:
                  "Style it your way: We generate outfits based on your preferences.",
              },
              {
                tagName: "Show Looks",
                tagDescription:
                  "See your vision come alive: Browse and choose looks you love.",
              },
            ]}
          />
        </Popup>
