...
export const ReImaginedNewWebsiteScope: FC<Props> = ({ scaling }) => {
      ...
      <div className={styles.subContainer}>
        ...
        <div className={styles.reportContainer}>
          ...
          <TopReport
            ...
            name={"ReportSection221ba6c262b7f7d91f50"}
            url={
              "https://app.powerbi.com/groups/aa5b399b-2191-4760-b9e6-751e8729eed7/reports/6fe52bb1-3b77-4baf-a441-eb09695c9b0a/ReportSection221ba6c262b7f7d91f50?experience=power-bi"
            }
            background={"white"}
          />
        </div>
